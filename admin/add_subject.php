						...
						<div class="block-content collapse in">
							...
							<form class="form-horizontal" method="post">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="subject_code" id="inputEmail" placeholder="Codigo Materia">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputPassword">Titulo Materia</label>
									<div class="controls">
										<input type="text" class="span8" name="title" id="inputPassword" placeholder="Titulo Materia" required>
									</div>
								</div>
								<div class="control-group">
							...
							if (isset($_POST['save'])) {
								...
								<?php
									...
									mysqli_query($con, "insert into activity_log (date,username,action) values(NOW(),'$user_username','Agregar Materia $subject_code')") or die(mysqli_error($con));
