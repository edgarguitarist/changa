...
<body>
    ...
    ?>
    <a class="btn btn-info" style="font-size:large; padding: 10px 20px; margin-bottom:20px !important; margin-left:40px !important;" href="index2.php?id_class=<?= $id_class ?>&id_teacher=<?= $id_teacher?>"><em class="fas fa-undo-alt"></em> Regresar</a>

    <div style="margin: 0 20px;">
        <?php
        $query = "SELECT * FROM histories WHERE id_class = '$id_class' AND id_history = '$id_history'";
