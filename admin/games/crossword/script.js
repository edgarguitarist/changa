...
function keyup(elm,focus) {
  ...
  if (T==false && R==true && B==true && L==true && dir=='down') { document.getElementById('direction').innerHTML='Verticalmente'; dir='down'; }  //top down 
  if (T==true && R==false && B==true && L==false && dir=='down') { document.getElementById('direction').innerHTML='Verticalmente'; dir='down'; } //down
  if (T==true && B==false && dir=='down') { return; } //bottom down
    
  if (T==true && R==true && B==true && L==false && dir=='across') { document.getElementById('direction').innerHTML='Horizontalmente'; dir='across'; } //left across
  if (L==true && R==false && dir=='across') { return; } //end across

  if (B==true && L==false && focus==true) { document.getElementById('direction').innerHTML='Verticalmente'; dir='down'}
  if (R==true && T==false && focus==true) { document.getElementById('direction').innerHTML='Horizontalmente'; dir='across'} 
  
  document.getElementById('debugger').innerHTML='T='+T+' : '+'R='+R+' : B='+B+' : '+'L='+L+  ' : '+'row='+row+  ' : '+'col='+col+  ' : '+'focus='+focus;
...
function Crossword(words_in, clues_in){
    ...
    if(words_in.length != clues_in.length) throw "El número de palabras debe ser igual al número de pistas.";	
        ...
        for(var r = 0; r < grid.length; r++){
            ...
            for(var c = 0; c < grid[r].length; c++){
                ...
                if(is_start_of_word) {
                    ...
                    html.push("<td class='" + css_class + "' style=\"background-size: 15px; background-image:url('" + img_url + "')\">");
                    label++;			
                } else {
