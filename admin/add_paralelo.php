   ...
   <?php
    if (isset($_POST['save'])) {
        ...
        $query = mysqli_query($con, "select * from paralelo where paralelo_name = '$d' and dean = '$pi' ") or die(mysqli_error($con));
       ...
       <?php
            ...
            mysqli_query($con, "insert into paralelo (paralelo_name,dean) values('$d','$pi')") or die(mysqli_error($con));
        ?>
           <script>
