	...
	<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
                                         ...
                                         <?php
                                    $query = mysqli_query($con,"select student.student_id, student.dni,student.celular, student.status, student.username, student.firstname, student.lastname, paralelo.paralelo_name, class.class_name from student 
