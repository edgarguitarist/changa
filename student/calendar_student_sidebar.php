<div class="span3" id="sidebar"><center>
	<img id="avatar" class="img-circle" src="../admin/<?php echo $row['location']; ?>">
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li class=""><a href="downloadable_student.php<?php echo '?id='.$get_id; ?>"><em class="icon-chevron-right"></em><em class="icon-download"></em>&nbsp;Prácticas</a></li>
				<li class=""><a href="video_student.php<?php echo '?id='.$get_id; ?>"><em class="icon-chevron-right"></em><em class="icon-download"></em>&nbsp;Videos</a></li><li class=""><a href="assignment_student.php<?php echo '?id='.$get_id; ?>"><em class="icon-chevron-right"></em><em class="icon-book"></em>&nbsp;Material Adicional</a></li>
				...
				<li class="active"><a href="class_calendar_student.php<?php echo '?id='.$get_id; ?>"><em class="icon-chevron-right"></em><em class="icon-calendar"></em>&nbsp;Horario de Clases</a></li>
