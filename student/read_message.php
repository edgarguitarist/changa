...
mysqli_query($con,"insert into message (reciever_id,content,date_sended,sender_id,reciever_name,sender_name,message_status) values('$sender_id','$my_message',NOW(),'$session_id','$sender_name','$my_name','')")or die(mysqli_error($con));
