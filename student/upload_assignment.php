...
if ($_FILES['uploaded_file']['size'] >= 10485760000 * 10) {
...
if ((!empty($_FILES["uploaded_file"])) && ($_FILES['uploaded_file']['error'] == 0)) {
	...
	$name_notification  = 'a enviado la tarea '." ".'<b>'.$name.'</b>'; 
        ...
        if (!file_exists($newname)) {
            ...
            if ((move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname))) {
                ...
                mysqli_query($con,"insert into teacher_notification (teacher_class_id,notification,date_of_notification,link,student_id,assignment_id) value('$get_id','$name_notification',NOW(),'view_submit_assignment.php','$session_id','$assignment_id')")or die(mysqli_error($con));
			   //$result = @mysql_query($qry);
                $qry2 = ("INSERT INTO student_assignment (fdesc,floc,assignment_fdatein,fname,assignment_id,student_id,grade) VALUES ('$filedesc','$newname1',NOW(),'$name','$assignment_id','$session_id','')")or die(mysqli_error($con));
