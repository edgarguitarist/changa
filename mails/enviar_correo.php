<?php
	...
	require 'admin/vendors/PHPMailer/Exception.php';
	require 'admin/vendors/PHPMailer/PHPMailer.php';
	require 'admin/vendors/PHPMailer/SMTP.php';
	...
	if (!empty($_POST)){$email = $_POST['email'];}else{$email = $_GET['email'];}
		...
		$contador = mysqli_num_rows($resultado);
    	 ...
    	 if($contador == 1) {
			...
			//echo $token;
			//echo $nombre;
			$url = 'http://'.$_SERVER["SERVER_NAME"].'/update_pass.php?idus='.$token;
