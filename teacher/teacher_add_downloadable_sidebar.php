<div class="span3" id="sidebar"><center>
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class=""><a href="add_assignment.php"><em class="icon-chevron-right"></em><em class="icon-plus-sign"></em>&nbsp;Agregar Prácticas</a></li> 
		...
		<li class="active"><a href="add_downloadable.php"><em class="icon-chevron-right"></em><em class="icon-plus-sign"></em>&nbsp;Agregar Material Adicional</a></li> 
