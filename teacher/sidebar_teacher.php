<div class="span3 tcenter" id="sidebar">
    <center>
        ...
        <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
            ...
            <li class=""><a href="teacher_share.php"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;Documentos &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; Compartidos</a></li> <!-- Sacar Posiblemente-->
        </ul>
