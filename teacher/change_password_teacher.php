						...
						<div class="block-content collapse in">
							...
							<div class="span6 border_span">
								...
								<form method="post" id="change_password" class="form-horizontal">
									...
									<div class="control-group">
										<div class="controls">
											<button type="submit" class="btn btn-success"><em class="icon-save"></em> Guardar</button>
										</div>
									</div>
								</form>
									...
									jQuery(document).ready(function() {
										jQuery("#change_password").submit(function(e) {
											...
											if (password != current_password) {
												$.jGrowl("La contraseña no es igual a la  Contraseña actual  ", {
													header: 'Cambiar Contraseña Fallido'
												});
											} else if (new_password != retype_password) {
												$.jGrowl("La contraseña no es igual a la  Nueva contraseña  ", {
													header: 'Cambiar Contraseña Fallido'
												});
												...
												$.ajax({
													...
													success: function(html) {
														...
														$.jGrowl("Tu contraseña fue cambiada!", {
															header: 'Cambiar Contraseña Exitoso'
														});
														var delay = 2000;
														setTimeout(function() {
