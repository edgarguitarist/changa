	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="exampleModalLabel">¿Esta seguro de copiar el archivo<?php //echo $student_name;
																								?> ?</h4>
				...
				<center>
					<div class="control-group">
						...
						where teacher_id = '$session_id' and school_year = '$school_year_id' ") or die(mysqli_error($con));
								...
								<button name="share" class="btn btn-success"><em class="icon-copy"></em> Copiar</button>
							</div>
						</div>
					</div>
